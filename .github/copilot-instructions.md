...
- Favor smart pointers (`std::unique_ptr`, `std::shared_ptr`) over raw pointers if theres a reason to actually use it over raw pointers.
...
- [Modern Cmake Article](https://cliutils.gitlab.io/modern-cmake/)
- [learncpp: modern and the bset C++ tutorial](https://www.learncpp.com/)